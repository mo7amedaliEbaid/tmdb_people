...
// in tmdb/test/data/repositories/person_details_repository_test.dart.
...
import 'package:tmdb/core/api_client.dart' as _i2;
import 'package:tmdb/data/data_sources/tmdb_api.dart' as _i3;
...
class MockTmdbApi extends _i1.Mock implements _i3.TmdbApi {
  MockTmdbApi() {
  ...
  @override
  _i4.Future<List<Map<String, dynamic>>> getPersonImages(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPersonImages,
          [id],
